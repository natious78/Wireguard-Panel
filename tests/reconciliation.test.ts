...
const remote:RemoteWireGuardPeer={id:"*1",interfaceName:"wg0",name:"Alice",comment:"Alice",publicKey:"public",allowedAddress:"10.0.0.2/32",endpointAddress:null,endpointPort:null,persistentKeepalive:25,disabled:false,lastHandshakeAt:null,rxBytes:0n,txBytes:0n};
