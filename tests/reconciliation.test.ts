...
const remote:RemoteWireGuardPeer={id:"*1",interfaceName:"wg0",name:"User A",comment:"User A",publicKey:"public",allowedAddress:"10.0.0.2/32",endpointAddress:null,endpointPort:null,persistentKeepalive:25,disabled:false,lastHandshakeAt:null,lastHandshakeRaw:null,lastHandshakeParseValid:true,rxBytes:0n,txBytes:0n};
